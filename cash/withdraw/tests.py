...
class AdminCheckWithdrawTest(AbstractTest):
    ...
    def test_user_and_pk_both_valid_but_users_differ(self):
        ...
        self.assertRaises(AmbiguousArgumentException,
                          lambda: self.WITHDRAW_CLASS(alternate_user, instance.withdraw_object.pk))
    ...
    def test_payout_doesnt_modify_status_on_exception(self):
        ...
        self.assertRaises(CheckWithdrawCheckNumberRequiredException,
                          lambda: w.payout())  # we dont care the type of exception in this test
...
class WithdrawTest(AbstractTest):
    ...
    def test_check_withdraw(self):
        ...
        self.assertRaises(TaxInformationException, lambda: self.__make_withdrawal_check(
