...
logger = getLogger('prize.helpers')
...
# onehundred_entry_template = [100,
#                              [(1, 12), (1, 10), (1, 8), (1, 6), (2, 5), (2, 4), (2, 3), (5, 2.5), (5, 2), (5, 1.5)]]
# twohundred_entry_template = [200,
#                              [(1, 16), (1, 12), (1, 10), (2, 8), (3, 6), (4, 5), (4, 4), (4, 3), (10, 2.5), (10, 2),
#                               (10, 1.5)]]
...
def create(buyin, entries, payouts):
    ...
    try:
        ...
        logger.info("buyin: %s payout_spots: %s first_place actual value:%s" % (buyin, total_payout_spots, first_place))
    ...
    for number_at_spot, multiples_of_buyin in payouts:
        ...
        for x in range(number_at_spot):
            ...
            try:
                ...
                Rank.objects.get(prize_structure=prize_structure, rank=rank_idx)
...
def create_templates():
    ...
    for amount in amounts:
        for template in templates:
            logger.info('amount', str(amount), 'entries', str(template[0]), 'structure', str(template[1]))
...
def create_initial_data():
    ...
    for amount in amounts:
        ...
        try:
            ...
            logger.warning(
                'create_initial_data() - a prize structure for buyin [%s] exists... skipping!' % str(amount))
            continue
        ...
        try:
            #
            # there is only going to be ONE rank (payout) per headsup prize structure
            Rank.objects.get(prize_structure__pk=prize_structure.pk)
        except Rank.DoesNotExist:
            #
            rank = Rank()
