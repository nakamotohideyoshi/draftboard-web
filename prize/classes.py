...
#
#         # get the ContestType model for CashAmount
#         # cash_amount_type = ContentType.objects.get_for_model( CashAmount )
#         # print( 'cash_amount_type', str(cash_amount_type))
#         # print( 'type(cash_amount_type)', str(type(cash_amount_type)))
#         cash_amount_type = get_content_type( cash_amount )
#         #update_all_contenttypes()
#
#         try:
#             #
...
#             rank.rank               = 1
#             rank.amount_id          = cash_amount.pk
#             rank.amount_type        = cash_amount_type
