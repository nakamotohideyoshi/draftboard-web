...
class Command(BaseCommand):
    ...
    help = 'usage: ./manage.py ticketprizes <buyin> <ticketAmount> <numPayouts> <optionalName>'
    ...
    def handle(self, *args, **options):
        ...
        creator = TicketPrizeStructureCreator(buyin, ticket_amount, num_payouts, name=name)
        creator.save()