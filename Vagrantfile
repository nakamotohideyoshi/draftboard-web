...
Vagrant.configure(2) do |config|
  ...
  #
  # install vim
  ###config.vm.provision :shell, path: "./site-setup/bootstrap.sh"
  ...
  ##
  ## configure the db machine which will have postgres up and running on it
  #config.vm.define "db" do |db|
  #  #
  #  # were going to use ubuntu
  #  db.vm.box = "ubuntu/trusty64"
  #
  #  #
  #  # configure db server to listen to default postgres port
  #  db.vm.network "private_network", ip: "192.168.50.100"
 # 
  #  #
  #  # provision the things to install
