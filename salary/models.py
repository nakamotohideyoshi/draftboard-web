...
class SalaryConfig(models.Model):
    ...
    min_avg_fppg_allowed_for_avg_calc = models.FloatField(null = False,
                                            default=0.0,
                                            help_text="The minimum fppg allowed for a players stats to be used to calculate position averages.",
...
class TrailingGameWeight(models.Model):
    ...
    weight = models.FloatField(null = False, help_text="Multiplier")
