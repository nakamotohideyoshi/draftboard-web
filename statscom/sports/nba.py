...
from statscom.classes import (
    ...
    StatsPlayer,
    PlayersAbstract)
from statscom.constants import STATPOINT_TO_STATSCOM_NBA
from statscom.player import get_fantasy_point_projection_from_stats_projection

logger = getLogger('statscom.sports.nba')
# For all scheduling purposes, EST is assumed
tz = pytz.timezone('America/New_York')


class DailyGamesNBA(DailyGamesAbstract):
...
class PlayersNBA(PlayersAbstract):
