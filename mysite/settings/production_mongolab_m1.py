...
MONGO_SERVER_ADDRESS    = 'ds057273-a0.mongolab.com'    #environ.get('MONGO_SERVER_ADDRESS')   # ie: '123.132.123.123'
...
MONGO_PORT              =  int(57273)                   #int(environ.get('MONGO_PORT'))        # 27017              cast MONGO_PORT to integer!
