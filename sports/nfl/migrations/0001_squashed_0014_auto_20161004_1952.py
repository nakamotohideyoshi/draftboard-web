# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-11-15 12:45
...
# sports.nfl.migrations.0004_auto_20160302_1121
...
class Migration(migrations.Migration):
    ...
    replaces = [('nfl', '0001_initial'), ('nfl', '0002_auto_20150528_2321'), ('nfl', '0003_auto_20150625_0016'), ('nfl', '0004_game_prev_status'), ('nfl', '0005_tsxinjury_tsxnews_tsxplayer_tsxteam_tsxtransaction'), ('nfl', '0006_auto_20160110_2114'), ('nfl', '0007_auto_20160110_2223'), ('nfl', '0008_player_season_fppg'), ('nfl', '0009_auto_20160119_2126'), ('nfl', '0002_player_lineup_nickname'), ('nfl', '0003_auto_20160229_1717'), ('nfl', '0004_auto_20160302_1121'), ('nfl', '0005_auto_20160302_1624'), ('nfl', '0006_auto_20160315_1530'), ('nfl', '0007_auto_20160315_1927'), ('nfl', '0008_player_on_active_roster'), ('nfl', '0009_auto_20160608_1315'), ('nfl', '0010_playerstats_fp_change'), ('nfl', '0011_auto_20160825_0015'), ('nfl', '0011_auto_20160819_2141'), ('nfl', '0012_merge'), ('nfl', '0011_auto_20160830_1435'), ('nfl', '0013_merge'), ('nfl', '0014_auto_20161004_1952')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('away_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_gameboxscore_away_team', to='contenttypes.ContentType')),
                ('home_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_gameboxscore_home_team', to='contenttypes.ContentType')),
                ('updated', models.DateTimeField(auto_now=True, default=datetime.datetime(2016, 1, 19, 2, 26, 5, 335073, tzinfo=utc))),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_gameportion_sport_game', to='contenttypes.ContentType')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_injury_injured_player', to='contenttypes.ContentType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game_id', models.PositiveIntegerField()),
                ('game_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_pbp_sport_game', to='contenttypes.ContentType')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(default='', max_length=1024)),
                ('srid', models.CharField(default='', max_length=64)),
                ('pbp_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_pbpdescription_pbpdesc_pbp', to='contenttypes.ContentType')),
                ('portion_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_pbpdescription_pbpdesc_portion', to='contenttypes.ContentType')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('injury_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='nfl_player_players_injury', to='contenttypes.ContentType')),
                ('position', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_player_player_position', to='sports.Position')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_playerstats_sport_game', to='contenttypes.ContentType')),
                ('player_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_playerstats_sport_player', to='contenttypes.ContentType')),
                ('position', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_playerstats_playerstats_position', to='sports.Position')),
                ('updated', models.DateTimeField(auto_now=True, default=datetime.datetime(2016, 1, 19, 2, 26, 6, 408614, tzinfo=utc))),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='player',
            name='team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nfl.Team'),
        ),
        migrations.AddField(
            model_name='game',
            name='away',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='game_awayteam', to='nfl.Team'),
        ),
        migrations.AddField(
            model_name='game',
            name='home',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='game_hometeam', to='nfl.Team'),
        ),
        migrations.AddField(
            model_name='game',
            name='prev_status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tsxcontent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_tsxinjury_tsxcontent', to='sports.TsxContent')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit', models.CharField(max_length=128)),
                ('content', models.CharField(max_length=16384)),
                ('tsxcontent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_tsxnews_tsxcontent', to='sports.TsxContent')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tsxitem_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_tsxplayer_tsxitem_tsxitemref', to='contenttypes.ContentType')),
                ...
                ('player', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='nfl.Player')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128)),
                ('tsxitem_id', models.PositiveIntegerField()),
                ('tsxitem_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_tsxteam_tsxitem_tsxitemref', to='contenttypes.ContentType')),
                ('content_published', models.DateTimeField(default=datetime.datetime(1999, 1, 1, 12, 0, tzinfo=utc), help_text='the item ref is a GFK so also store the publish date here for ordering purposes.')),
                ('team', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='nfl.Team')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit', models.CharField(max_length=128)),
                ('content', models.CharField(max_length=16384)),
                ('tsxcontent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nfl_tsxtransaction_tsxcontent', to='sports.TsxContent')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='game',
            name='updated',
            field=models.DateTimeField(auto_now=True, default=datetime.datetime(2016, 1, 19, 2, 26, 4, 328274, tzinfo=utc)),
        ...
        migrations.AddField(
            model_name='game',
            name='season',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='nfl.Season'),
            preserve_default=False,
        ),
        ...
        migrations.AlterField(
            model_name='player',
            name='status',
            field=models.CharField(default='', help_text='roster status - ie: "A01" means they are ON the roster. Not particularly active as in not-injured!', max_length=64),
        ),
        migrations.AddField(
