...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        #     model_name='game',
        #     name='season',
        #     field=models.ForeignKey(to='nba.Season', default=1),
        ...
        migrations.AddField(
            model_name='season',
            name='srid',
            field=models.CharField(default='nba', help_text='the sportsradar global id of the season/schedule', max_length=64, unique=True),
            preserve_default=False,
        ),
