# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-11-15 12:42
...
# sports.nba.migrations.0004_auto_20160302_1121
...
class Migration(migrations.Migration):
    ...
    replaces = [('nba', '0001_initial'), ('nba', '0002_auto_20150528_2321'), ('nba', '0003_auto_20150625_0016'), ('nba', '0004_game_prev_status'), ('nba', '0005_auto_20151016_1942'), ('nba', '0006_tsxinjury_tsxnews_tsxplayer_tsxteam_tsxtransaction'), ('nba', '0007_injury_ddtimestamp'), ('nba', '0008_auto_20160110_2112'), ('nba', '0009_auto_20160110_2242'), ('nba', '0010_player_season_fppg'), ('nba', '0011_auto_20160119_2125'), ('nba', '0002_player_lineup_nickname'), ('nba', '0003_auto_20160229_1717'), ('nba', '0004_auto_20160302_1121'), ('nba', '0005_auto_20160302_1624'), ('nba', '0006_playerstats_minutes'), ('nba', '0007_auto_20160315_1524'), ('nba', '0008_auto_20160315_1927'), ('nba', '0009_player_on_active_roster'), ('nba', '0010_playerstats_fp_change'), ('nba', '0011_game_boxscore_data'), ('nba', '0012_auto_20161004_2000')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('away_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_gameboxscore_away_team', to='contenttypes.ContentType')),
                ('home_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_gameboxscore_home_team', to='contenttypes.ContentType')),
                ('updated', models.DateTimeField(auto_now=True, default=datetime.datetime(2016, 1, 19, 2, 25, 5, 183133, tzinfo=utc))),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_gameportion_sport_game', to='contenttypes.ContentType')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_injury_injured_player', to='contenttypes.ContentType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game_id', models.PositiveIntegerField()),
                ('game_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_pbp_sport_game', to='contenttypes.ContentType')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(default='', max_length=1024)),
                ('srid', models.CharField(default='', max_length=64, unique=True)),
                ('pbp_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_pbpdescription_pbpdesc_pbp', to='contenttypes.ContentType')),
                ('portion_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_pbpdescription_pbpdesc_portion', to='contenttypes.ContentType')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('injury_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='nba_player_players_injury', to='contenttypes.ContentType')),
                ('position', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_player_player_position', to='sports.Position')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_playerstats_sport_game', to='contenttypes.ContentType')),
                ('player_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_playerstats_sport_player', to='contenttypes.ContentType')),
                ('position', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_playerstats_playerstats_position', to='sports.Position')),
                ('updated', models.DateTimeField(auto_now=True, default=datetime.datetime(2016, 1, 19, 2, 25, 6, 311945, tzinfo=utc))),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('srid', models.CharField(default='nba', help_text='the sportsradar global id of the season/schedule', max_length=64, unique=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='game',
            name='away',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='game_awayteam', to='nba.Team'),
        ),
        migrations.AddField(
            model_name='game',
            name='home',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='game_hometeam', to='nba.Team'),
        ),
        migrations.AddField(
            model_name='game',
            name='prev_status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tsxcontent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_tsxinjury_tsxcontent', to='sports.TsxContent')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit', models.CharField(max_length=128)),
                ('content', models.CharField(max_length=16384)),
                ('tsxcontent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_tsxnews_tsxcontent', to='sports.TsxContent')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tsxitem_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_tsxplayer_tsxitem_tsxitemref', to='contenttypes.ContentType')),
                ...
                ('player', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='nba.Player')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128)),
                ('tsxitem_id', models.PositiveIntegerField()),
                ('tsxitem_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_tsxteam_tsxitem_tsxitemref', to='contenttypes.ContentType')),
                ('content_published', models.DateTimeField(default=datetime.datetime(1999, 1, 1, 12, 0, tzinfo=utc), help_text='the item ref is a GFK so also store the publish date here for ordering purposes.')),
                ('team', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='nba.Team')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit', models.CharField(max_length=128)),
                ('content', models.CharField(max_length=16384)),
                ('tsxcontent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nba_tsxtransaction_tsxcontent', to='sports.TsxContent')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='game',
            name='season',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='nba.Season'),
            preserve_default=False,
        ),
