    ...
    return new Promise((resolve, reject) => {
      ...
      .end(function(err, res) {
        if(err) {
          ...
          console.error('fetchDraftGroupBoxScores action is loading fixture data because at the time the endpoint was broken.', res.body)
          dispatch(fetchDraftGroupBoxScoresSuccess(draftGroupId, fixtures))
        } else {
